...
<f:view>
	...
	<body class="page">
		<jsp:include page="header.jsp?headerTitle=Subscription"/>
		<!-- div start container -->
		<div class="container">
			<div class="center">
		...
		<div class="contacts left">
			<div>
				<div>			
					<div>
						<h3><b><h:outputText value="#{userSubscription.subscription.billingCode}"/></b></h3>
						<dl>
							<dt>Price Per Month</dt>
							<dd>
								<p>$<h:outputText value="#{userSubscription.subscription.price}"/></p>
							</dd>
							
							<dt>Messages Per Month</dt>
							<dd>
								<p><h:outputText value="#{userSubscription.subscription.messageLimit}"/></p>
							</dd>
							
							<dt>Usage This Month</dt>
							<dd>
								<p><h:outputText value="#{userSubscription.usage}"/></p>
							</dd>
							
							<dt>Next Billing Date</dt>
							<dd>
								<p><h:outputText value="#{userSubscription.nextBillingDate}"/></p>
							</dd>
							
							<dt></dt>
							<dd>
							<h:form id="subdel">
							<h:commandLink styleClass="link-btn" action="#{subscriptionBackingBean.deleteAction}">Delete Subscription</h:commandLink>
							</h:form>
							</dd>
						</dl>
					</div>				
